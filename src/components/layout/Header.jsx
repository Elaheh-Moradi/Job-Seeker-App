...
export default function Header() {
  ...
  return (
    <>
      <div
        dir="rtl"
        className="flex justify-between  items-center bg-[#444] h-[10.5vh]"
      >
        <ul
          dir="rtl"
          className=" flex justify-center items-center list-none mr-[10vh] "
        >
          <li className="relative pt-6 pb-6 pl-3.5 pr-3.5">
          ...
          <li className="pt-6 pb-6 pl-3.5 pr-3.5 relative">
            <div class="flex items-center text-[#fff] text-[14px] font-medium leading-relaxed">
              <SearchRoundedIcon
